...
class DocumentChunker:
    ...
    def __merge_small_parents(self, chunks): # merge all short chunk for min_parent_size
        if not chunks:
            return []
    ...
    def __split_large_parents(self, chunks): # cut long chunk for max_parent_size
        split_chunks = []
    ...
    def __clean_small_chunks(self, chunks): # clean odd chunk remain
        cleaned = []
